...
class SaldoOvoScreen extends StatelessWidget {
  SaldoOvoScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    ], child: _SaldoOvoScreenLayout());
  }
}

class _SaldoOvoScreenLayout extends StatefulWidget {
  const _SaldoOvoScreenLayout({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _SaldoOvoScreenState();
}

class _SaldoOvoScreenState extends State<_SaldoOvoScreenLayout> {
                                    ...
                                    onPressed: () {
                                      ...
                                      showDialog(
                                        ...
                                        builder: (context) =>
                                          ...
                                          imageProductPath: Assets.ic_ovo,
