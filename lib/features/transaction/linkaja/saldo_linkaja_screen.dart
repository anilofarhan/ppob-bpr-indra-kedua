...
class SaldoLinkajaScreen extends StatelessWidget {
  SaldoLinkajaScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    ], child: _SaldoLinkajaScreenLayout());
  }
}

class _SaldoLinkajaScreenLayout extends StatefulWidget {
  const _SaldoLinkajaScreenLayout({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _SaldoLinkajaScreenState();
}

class _SaldoLinkajaScreenState extends State<_SaldoLinkajaScreenLayout> {
        ...
        BlocListener<PaymentPulsaPrabayarBloc, BlocState>(
          listener: (context, state) {
            if (state is PaymentPulsaSuccessState) {
              ...
              print("link saja"+data.toString());
              print("link saja1"+data.customerData!.toString());
              print("link saja1"+data.billAmount!.toString()+" "+data.trxid!);
      ...
      child: Scaffold(
        ...
        appBar: CustomAppBarText(
          title: RichText(
            text: TextSpan(
                children: [
                  TextSpan(text: Strings.topup_linkaja, style: Style.text18spWhiteBoldItalic),
                ]
            ),
          ),
          elevation: false,
                          ...
                          child: Column(
                            ...
                            children: [
                              RichText(
                                text: TextSpan(
                                    children: [
                                      TextSpan(text: "Masukkan nomor ponsel yang terdaftar pada aplikasi ", style: Style.text11spWhite),
                                      TextSpan(text: "LinkAja", style: Style.text11spWhiteItalic),
                                    ]
                                ),
                              ),
                              InputNoPelanggan(
                                  iconPath: Assets.ic_linkaja,
                                ...
                                onPressed: () {
                                  ...
                                  showDialog(
                                    ...
                                    builder: (context) =>
                                      ...
                                      imageProductPath: Assets.ic_linkaja,
