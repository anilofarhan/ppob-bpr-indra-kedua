...
class TvPrabayarRepositoryImpl extends TvPrabayarRepository {
  @override
  Future<BaseResponse<List<TransactionResponseModel>>> postInquiryTvPrabayar(
      InquiryTvEvent event) async {
    var map = {
      "method": RequestMethod.TRANSACTION,
      "processing_code": ProccesingCode.TRX_TV_BERBAYAR_INQ,
  ...
  Future<BaseResponse<List<TransactionResponseModel>>> postPaymentTvPrabayar(
      PaymentTvEvent event) async {
    var map = {
      "method": RequestMethod.TRANSACTION,
      "processing_code": ProccesingCode.TRX_TV_BERBAYAR_PAY,
      "reg_no": Constants.NO_REKENING,
      "cif": event.cif,
      "cid": event.cid,
