...
import 'package:ppob/core/utilities/paket_data_provider_util.dart';
...
class PaketDataScreen extends StatelessWidget {
  PaketDataScreen({Key? key}) : super(key: key);
...
class _PulsaPrabayarScreenState extends State<_PulsaPrabayarLayout> {
  ...
  void _getHargaPublic() {
    prefix = PaketDataProviderUtil
        .prefixModel[noPonselController.text.substring(0, 4)];
    if (prefix == null) {
    ...
    BlocProvider.of<HargaPulsaPublicBloc>(context)
        .add(HargaPulsaPublicEvent(provider: prefix!.productCode));
  }
          ...
          listener: (context, state) {
            if (state is PaymentPulsaSuccessState) {
              ...
              String ss = "<div style='width:100%;font-size:16px'><br/>" +
                  ...
                  data.produk! +
                  "</div><br/><table style='width:100%;'><tr><td>PRODUK</td style='width:100px;'><td>\t\t:\t\t</td><td>" +
                  col1[1] +
                  "</td></tr><tr><td>PAKET</td><td>\t\t:\t\t</td><td> " +
                  col1[3].trim() +
                  "</td></tr><tr><td>NO PONSEL</td><td>\t\t:\t\t</td><td>" +
                  col1[2] +
                  "</td></tr><tr><td>TOTAL BAYAR</td><td>\t\t:\t\t</td><td>Rp. " +
                  data.billAmount!.currencyFormat() +
                  "</td></tr><tr><td>KODE TRX</td><td>\t\t:\t\t</td><td></td></tr><tr><td colspan='3'>" +
                  data.trxid! +
                  "</td></tr></table></div>";
              ...
              showDialog(
                ...
                builder: (context) => DialogPaymentSukses(
                  ...
                  fileName: "ppob_paketdata_"+data.trxid!,
                ),
              );
