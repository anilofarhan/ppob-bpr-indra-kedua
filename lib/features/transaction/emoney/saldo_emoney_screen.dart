...
class SaldoEmoneyScreen extends StatelessWidget {
  SaldoEmoneyScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    ], child: _SaldoEmoneyScreenLayout());
  }
}

class _SaldoEmoneyScreenLayout extends StatefulWidget {
  const _SaldoEmoneyScreenLayout({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _SaldoEmoneyScreenState();
}

class _SaldoEmoneyScreenState extends State<_SaldoEmoneyScreenLayout> {
  ...
  void _enableBtn() {
    if (noPonselController.text.length == 16 && selectHargaPulsa > -1) {
      setState(() {
        isEnabledBtn = true;
      });
    } else {
          ...
          listener: (context, state) {
            if (state is PaymentPulsaSuccessState) {
              ...
              final ss = "<div style='width:100%;font-size:16px'>" +
                  ...
                  " WITA<br/><br/><div style='font-weight: bold;'>TOP UP " +
                  col1[1] +
      ...
      child: Scaffold(
        ...
        appBar: CustomAppBarText(
          title: RichText(
            text: TextSpan(
                children: [
                  TextSpan(text: "Top up ", style: Style.text18spWhiteBoldItalic),
                  TextSpan(text: "Saldo E-", style: Style.text18spWhiteBold),
                  TextSpan(text: "Money", style: Style.text18spWhiteBoldItalic)
                ]
            ),
          ),
          elevation: false,
                          ...
                          child: Column(
                            ...
                            children: [
                              RichText(
                                text: TextSpan(
                                    children: [
                                      TextSpan(text: "Masukkan 16 digit nomor kartu Mandiri e-", style: Style.text11spWhite),
                                      TextSpan(text: "money", style: Style.text11spWhiteItalic),
                                      TextSpan(text: " (di belakang kartu)", style: Style.text11spWhite)
                                    ]
                                ),
                              ),
                              InputNoPelanggan(
                                  iconPath: Assets.ic_emoney,
                                  title: Strings.nomor_kartu,
                                  hintText: "",
                                ...
                                onPressed: () {
                                  ...
                                  showDialog(
                                    ...
                                    builder: (context) =>
                                      ...
                                      imageProductPath: Assets.ic_emoney,
                                      noPelanggan: noPonselController.text,
                                      productName: "E-Money",
                                      deskripsi:
                                          "Top up saldo e-money ${hargaPublisList[selectHargaPulsa].kodeProduk!.currencyFormat()}\nHarga : ${hargaPublisList[selectHargaPulsa].hargaPublic!.currencyFormat2()}",
                                    ),
                                  );
                                },
                                width: double.infinity,
                              ...
                              RichText(
                                text: TextSpan(
                                    children: [
                                      TextSpan(text: "* Harap ", style: Style.text14spBlack),
                                      TextSpan(text: "update ", style: Style.text14spBlackItalic,),
                                      TextSpan(text: "saldo kartu Anda di ATM dan ", style: Style.text14spBlack),
                                      TextSpan(text: "channel ", style: Style.text14spBlackItalic,),
                                      TextSpan(text: "Bank Mandiri / gerai retail terdekat, setelah melakukan ", style: Style.text14spBlack),
                                      TextSpan(text: "Top up.", style: Style.text14spBlackItalic,),
                                    ]
                                ),
                              ),
                             /* Text(
