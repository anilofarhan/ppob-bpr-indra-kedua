...
class PulsaPascabayarRepositoryImpl extends PulsaPascabayarRepository {
  @override
  Future<BaseResponse<List<TransactionResponseModel>>> inquiryPulsaPascabayar(
      InquiryPulsaPascabayarEvent event) async {
    var map = {
      "method": RequestMethod.TRANSACTION,
      "processing_code": ProccesingCode.TRX_HP_PASCABAYAR_INQ,
  ...
  Future<BaseResponse<List<TransactionResponseModel>>> paymentPulsaPascabayar(
      PaymentPulsaPascabayarEvent event) async {
    var map = {
      "method": RequestMethod.TRANSACTION,
      "processing_code": ProccesingCode.TRX_HP_PASCABAYAR_PAY,
      "reg_no": Constants.NO_REKENING,
      "cif": event.cif,
      "cid": event.cid,
      "traceNo": await TraceNoUtils.getTraceNo(),
